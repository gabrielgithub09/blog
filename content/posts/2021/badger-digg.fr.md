...
description: "BadgerDAO se trouve en première ligne sur deux thèmes très tendance : la gestion d'actifs en DeFi (vaults/setts) & BTC sur Ethereum. Voyons donc ce qu'implique le projet et quel est son plan."
